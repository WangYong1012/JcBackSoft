...
/* 14:   */ @Controller
/* 15:   */ @Scope("prototype")
/* 16:   */ public class Delete_suggest
/* 17:   */ {
/* 18:   */   @Autowired
/* 19:   */   private SuggestService suggestService;
/* 20:   */   
/* 21:   */   @ResponseBody
/* 22:   */   @RequestMapping(value={"/delete_suggest_id"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
...
/* 33:45 */       int list = this.suggestService.deleteSuggestById(suggestMap);
 ...
 * Qualified Name:     com.jcsoft.feature.controller.suggest.Delete_suggest
